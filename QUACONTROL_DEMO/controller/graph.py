...
class gen_graph:
    ...
    def data_bars(self, df, column, color):
    ...
    '''def grh_Multi_Line(self, data, x, y, legend,label_x = None, label_y = None,label_color = None,title=None, size_title=13, margin = [5, 5, 5, 5]):
